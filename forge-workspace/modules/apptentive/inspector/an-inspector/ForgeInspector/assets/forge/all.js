...
forge.apptentive = {
	...
	addDeviceData: function (success, error, key, value) {
		forge.internal.call('apptentive.addDeviceData', {
			key: key,
			value: value
		}, success, error);
	},

	removeDeviceData: function (success, error, key) {
		forge.internal.call('apptentive.removeDeviceData', {
			key: key
		}, success, error);
	},
